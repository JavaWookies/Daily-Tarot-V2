...
import static com.amcwustl.dailytarot.MainActivity.logCallbackName;
...
public class IronSourceRewardedVideoAdListener implements LevelPlayRewardedVideoListener {
    private final String TAG = IronSourceRewardedVideoAdListener.class.getSimpleName();
    private final DemoActivityListener listener;

    public IronSourceRewardedVideoAdListener(DemoActivityListener listener) {
